...
4. **[KEEP-AWARE] The 7-plugin bespoke Vite build is a known bus-factor-of-one liability.**
   ...
   it well-documented; the 558-test net is what makes it safe to refactor when needed.
...
13. **[KEEP] The 558-test (439 web + 119 functions) + 5-spec Playwright tier is a genuine
