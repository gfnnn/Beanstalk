...
//
// The per-piece page matters: piece pages are generated by a SEPARATE render
// path (src/build/piece-page.js, which bypasses Vite's HTML transforms and
// carries its own loader/CSP/SEO injection), so it's the one page family the
// other twelve entries can't vouch for. The slug comes from the live data so
// this can never point at a piece that stopped existing.
export const PAGES = [
  { path: '/',                       name: 'home' },
  { path: '/portfolio/',             name: 'portfolio' },
  { path: `/portfolio/${pieces[0].slug}/`, name: `piece page (${pieces[0].slug})` },
